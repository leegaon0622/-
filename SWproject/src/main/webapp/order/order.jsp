	...
	<div class="container">
		...
		<div class="row qnas" style="text-align: center;">
			...
			<table class="table table-hover" style="width: 70%; margin: auto; border-bottom: 1px solid #D5D5D5;">
				...
				<tbody>
						<tr>
							<td><img alt="thumbnail" src="/resources/upload${Product.filename}" width="40%">
							<input type="hidden" value="${dto.productId}" name="productId" id="productId">
							</td>
							<td>${Product.productName}<br>${Product.productInfo}</td>
							<td><fmt:formatNumber type="number" value="${Product.productprice}"/>&nbsp;원</td>
							<td><select name="order_Qty" class="form-control order_Qty">
								<c:forEach begin="1" end="${Product.productstock > 5 ? 5 : Product.productstock}" var="stock">
